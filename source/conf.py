...
# -*- coding: utf-8 -*-
#
# OpenTA documentation build configuration file, created by
# sphinx-quickstart on Wed Feb 22 14:16:36 2017.
#
...
man_pages = [(master_doc, 'openta', 'OpenTA Documentation', [author], 1)]
...
# --- Autogenerate pdfindex.rst for LaTeX builds ---
# Keep the HTML navigation untouched by building PDF from a separate
# autogenerated root that lists only the desired content pages.

# Ordered list of documents to include in the PDF toctree
PDF_TOC = [
    'overview/index',
    'overview/adoption',
    'author/index',
