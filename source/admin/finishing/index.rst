...
After server indicates its done, log in to the new course with your present login and password. Admins will be migrated wwhereas no students are imported. Dates and exercise options are left unchanged. Use ``Modify`` in the new course to shifthe dates typically by 52x7 = 364 days. Or wipe due dates clean by deselecting deadline_date. Uncheck the course options you don't want to keep. 

* Logout of the old course and login to the new. Admins but no students should be migrated.
 
3b) Setting up your new course with Canvas
================================================================

If you are using Canvas you must set up  student access via the Canvas page. 
...
* Copy the following three fields so you can paste into canvas
